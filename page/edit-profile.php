    ...
    if (empty($nama) || empty($email) || empty($username)) {
        ...
        if ($check_email->get_result()->num_rows > 0) {
            ...
            if (!empty($_FILES['foto_profil']['name'])) {
                $target_dir = dirname(__DIR__) . '/assets/uploads/profiles/';
                ...
                if (empty($error)) {
                    if (!is_dir($target_dir)) {
                        $error = 'Direktori upload tidak ditemukan setelah pembuatan!';
                    } elseif (!is_writable($target_dir)) {
                        $error = 'Direktori upload tidak dapat ditulis!';
                    }
                }
                ...
                if (empty($error)) {
                    ...
                    if ($real_path) {
                        ...
                        $error = 'Direktori upload tidak dapat diakses!';
                    }
                }
                ...
                if (empty($error)) {
                    ...
                    if (!in_array(strtolower($file_extension), $allowed_types)) {
                        ...
                        error_log("Is dir: " . (is_dir($target_dir) ? 'yes' : 'no'));
