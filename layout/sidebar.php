        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <?php if (isset($_SESSION['nama'])) : ?>
                    ...
                    <li class="sidebar-item <?= $kategori || $tambah || $ubah ? 'active' : '' ?>">
                        <a href="index.php?halaman=kategori" class="sidebar-link">
                            <i class="bi bi-person-fill"></i>
                            <span><?= __('Categories') ?></span>
                        </a>
                    </li>
                    <li class="sidebar-item <?= $produk || $tambah || $ubah ? 'active' : '' ?>">
                        <a href="index.php?halaman=produk" class="sidebar-link">
                            <i class="bi bi-person-fill"></i>
                            <span><?= __('Products') ?></span>
                        </a>
                    </li>
                    <li class="sidebar-item <?= $penjualan || $tambah || $ubah ? 'active' : '' ?>">
                        <a href="index.php?halaman=penjualan" class="sidebar-link">
                            <i class="bi bi-person-fill"></i>
